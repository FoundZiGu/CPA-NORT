...
var (
	geminiOAuthClientID     = strings.TrimSpace(os.Getenv("CPA_NORT_GEMINI_OAUTH_CLIENT_ID"))
	geminiOAuthClientSecret = strings.TrimSpace(os.Getenv("CPA_NORT_GEMINI_OAUTH_CLIENT_SECRET"))
)
...
var (
	antigravityOAuthClientID     = strings.TrimSpace(os.Getenv("CPA_NORT_ANTIGRAVITY_OAUTH_CLIENT_ID"))
	antigravityOAuthClientSecret = strings.TrimSpace(os.Getenv("CPA_NORT_ANTIGRAVITY_OAUTH_CLIENT_SECRET"))
)
