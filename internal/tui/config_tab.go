...
func (m configTabModel) parseConfig(cfg map[string]any) []configField {
	...
	fields = append(fields, configField{"Disable Auth Auto Refresh", "disable-auth-auto-refresh", "bool", fmt.Sprintf("%v", getBool(cfg, "disable-auth-auto-refresh")), nil})
...
func fieldSection(apiPath string) string {
	...
	switch apiPath {
	case "port", "host", "debug", "proxy-url", "request-retry", "max-retry-interval", "force-model-prefix", "disable-auth-auto-refresh":
