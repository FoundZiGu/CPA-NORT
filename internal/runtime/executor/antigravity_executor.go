...
var (
	antigravityClientID     = strings.TrimSpace(os.Getenv("CPA_NORT_ANTIGRAVITY_OAUTH_CLIENT_ID"))
	antigravityClientSecret = strings.TrimSpace(os.Getenv("CPA_NORT_ANTIGRAVITY_OAUTH_CLIENT_SECRET"))
)
...
func (e *AntigravityExecutor) Refresh(ctx context.Context, auth *cliproxyauth.Auth) (*cliproxyauth.Auth, error) {
	...
	if metaStringValue(auth.Metadata, "refresh_token") == "" {
		return auth, nil
	}
