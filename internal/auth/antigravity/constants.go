...
var (
	ClientID     = strings.TrimSpace(os.Getenv("CPA_NORT_ANTIGRAVITY_OAUTH_CLIENT_ID"))
	ClientSecret = strings.TrimSpace(os.Getenv("CPA_NORT_ANTIGRAVITY_OAUTH_CLIENT_SECRET"))
)
